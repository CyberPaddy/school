...
def main(P):
    ...
    fk_bits = fk_function(EP_bits1, K1, S0, S1, IP1, EP, P4, 1)
    ...
    fk_bits = fk_function(EP_bits2, K2, S0, S1, switched_fk_bits, EP, P4, 2)

    ######### Inverse permutation ###########

    print ("### INVERSE PERMUTATION ###")
    ciphertext = inverse_permutation(fk_bits, IP_)
    print ("To obtain ciphertext, apply IP^-1 = (4 1 3 5 7 2 8 6)\nCiphertext for string " + P + ": " + ciphertext + "\n")
